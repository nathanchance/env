...
# Usage
# -----
# $ . build_franco.sh <update|noupdate> <toolchain>
...
# Parameters
# ----------
# FETCHUPSTREAM: Whether or not to fetch new Franco updates
...
FRANCO_VER="${BASE_FRANCO_VER}${VER}${TOOLCHAIN_VER}"
...
function make_zip {
   ...
   mv  `echo ${FRANCO_VER}`.zip ${UPLOAD_DIR}
   cd ${KERNEL_DIR}
}
