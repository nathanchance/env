...
def create_monthly_report_file(report_file, report_date):
    ...
    template = (
        ...
        '  * `` ([`v1`]())'                                                '\n'
                                                                           '\n'
        '* Kbuild / Kconfig fixes and improvements: These are changes that '
        'I have authored as part of maintaining Kbuild and Kconfig.'       '\n'
                                                                           '\n'
        '  * `` ([`v1`]())'                                                '\n'
                                                                           '\n'
        '* Miscellaneous fixes and improvements: These are fixes and '
        "improvements that don't fit into a particular category but matter "
        'in some way to my other work.'                                    '\n'
                                                                           '\n'
        '  * `` ([`v1`]())'                                                '\n'
                                                                           '\n'
