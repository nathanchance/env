...
def prepare_source(base_name: str, base_ref: str = 'origin/master') -> None:
    ...
    if base_name == 'linux-next-llvm':
        patches += [
            ...
            '''From 5d728ebebbd127e5bffa389000b3ed05ee2abd21 Mon Sep 17 00:00:00 2001
From: Nathan Chancellor <nathan@kernel.org>
Date: Thu, 7 May 2026 18:29:51 +0800
Subject: [PATCH] Diff of updated version of "rseq: Implement read only ABI
 enforcement for optimized RSEQ V2 mode" from -tip
...
index fde12cf17168..2d0295df5107 100644
--- a/include/linux/rseq_entry.h
+++ b/include/linux/rseq_entry.h
@@ -476,22 +476,14 @@ rseq_update_user_cs(struct task_struct *t, struct pt_regs *regs, unsigned long c
...
@@ -500,7 +492,7 @@ bool rseq_set_ids_get_csaddr(struct task_struct *t, struct rseq_ids *ids,
 			if (uval != cpu_id)
 				goto die;
...
@@ -509,7 +501,7 @@ bool rseq_set_ids_get_csaddr(struct task_struct *t, struct rseq_ids *ids,
...
@@ -521,7 +513,7 @@ bool rseq_set_ids_get_csaddr(struct task_struct *t, struct rseq_ids *ids,
...
+	t->rseq.ids = *ids;
 	...
 	return true;
@@ -537,11 +529,11 @@ bool rseq_set_ids_get_csaddr(struct task_struct *t, struct rseq_ids *ids,
...
+	if (!rseq_set_ids_get_csaddr(t, ids, &csaddr))
 	...
 	/*
@@ -644,12 +636,12 @@ static __always_inline bool rseq_exit_user_update(struct pt_regs *regs, struct t
 	}
...
index 6ff62640dca5..e75e3a5e312c 100644
--- a/kernel/rseq.c
+++ b/kernel/rseq.c
