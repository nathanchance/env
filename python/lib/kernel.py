...
def prepare_source(base_name, base_ref='origin/master'):
    ...
    if base_name == 'linux-next-llvm':
        ...
        patches.append('https://lore.kernel.org/all/20241216233704.3208607-2-dwmw2@infradead.org/')  # x86/kexec: Disable global pages before writing to control page
        patches.append('https://lore.kernel.org/all/20241216233704.3208607-3-dwmw2@infradead.org/')  # x86/kexec: Ensure preserve_context flag is set on return to kernel
        patches.append('https://lore.kernel.org/all/20241216233704.3208607-4-dwmw2@infradead.org/')  # x86/kexec: Use correct swap page in swap_pages function
