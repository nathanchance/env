...
function cbl_rb_pi -d "Rebase Raspberry Pi kernel on latest linux-next"
    ...
    # Patching
    set -a b4_patches https://lore.kernel.org/all/20230413-fixes-for-mt8195-hdmi-phy-v1-1-b8482458df0d@baylibre.com/ # phy: mediatek: hdmi: mt8195: fix uninitialized variable usage in pll_calc
