...
function cbl_rb_fd -d "Rebase generic Fedora kernel on latest linux-next"
    ...
    set -a patches https://lore.kernel.org/all/20230202-dm-parenthesis-warning-v1-1-ebdee213eeb9@kernel.org/ # dm flakey: Fix clang -Wparentheses-equality in flakey_map()
