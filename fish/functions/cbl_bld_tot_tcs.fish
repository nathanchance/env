...
' | git -C $llvm_project ap
    ...
    set -a gh_prs https://github.com/llvm/llvm-project/pull/151259 # [clang][test] Require staticanalyzer for Modules/specializations-lazy-load-parentmap-crash.cpp
    for gh_pr in $gh_prs
