...
function cbl_bld_tot_tcs -d "Build LLVM and binutils from source for kernel development"
    ...
    echo 'diff --git a/clang/CMakeLists.txt b/clang/CMakeLists.txt
index ab2ac9bc6b9a..c9cebd7a3ceb 100644
...
index 35a8042ac0e0..4a746a68a7de 100644
--- a/clang/test/CMakeLists.txt
+++ b/clang/test/CMakeLists.txt
@@ -48,19 +48,19 @@ configure_lit_site_cfg(
...
' | git -C $llvm_project ap
    or return
    git -C $llvm_project rm clang/test/Unit/lit.{cfg.py,site.cfg.py.in}
    or return
