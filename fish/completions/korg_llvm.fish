...
complete -f -c korg_llvm -n "__fish_seen_subcommand_from folder" -s h -l help -d "Show help message and exit"
complete -f -c korg_llvm -n "__fish_seen_subcommand_from folder" -s p -l prefix -d "Print {prefix}"

complete -f -c korg_llvm -n "__fish_seen_subcommand_from install" -s h -l help -d "Show help message and exit"
...
complete -f -c korg_llvm -n "__fish_seen_subcommand_from latest" -s h -l help -d "show help message and exit"
...
complete -f -c korg_llvm -n "__fish_seen_subcommand_from var" -s h -l help -d "Show help message and exit"
